...
double fasterEMAnow9, slowerEMAnow5, fasterEMAprevious9, slowerEMAprevious5, fasterEMAafter9, slowerEMAafter5;
...
//--- Do we have positions opened already?
   ...
   p_close=mrate[1].close;  // bar 1 close price
    ...
    fasterEMAnow9 = iMA(NULL, 0, blue_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i);
    fasterEMAprevious9 = iMA(NULL, 0, blue_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i+1);
    fasterEMAafter9 = iMA(NULL, 0, blue_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i-1);

    slowerEMAnow5 = iMA(NULL, 0, black_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i);
    slowerEMAprevious5 = iMA(NULL, 0, black_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i+1);
    slowerEMAafter5 = iMA(NULL, 0, black_EMA_Period, 0, MODE_EMA, PRICE_CLOSE, i-1);
 ...
 */
  //BUY ORDER
  if ((fasterEMAnow9 > slowerEMAnow5) && (fasterEMAprevious9 < slowerEMAprevious5) && (fasterEMAafter9 > slowerEMAafter5))
  { // any opened Buy position?
         if (Buy_opened) 
         {
            Alert("We already have a Buy Position!!!"); 
